  ...
  return retorno;
    ...
    public String toString() {
        return "Personaje{" + "nombrePersonaje=" + nombrePersonaje 
                + ", nombreActor=" + nombreActor +this.mejorActor()
                +this.calidadActuacion()+ ", tipoPersonajeSegunRol=" 
                + tipoPersonajeSegunRol + ", descripcionPersonaje=" 
                + descripcionPersonaje + ", puntuacionPersonaje=" 
                + puntuacionPersonaje + '}';
    }
