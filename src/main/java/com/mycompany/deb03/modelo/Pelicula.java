 ...
 */
package com.mycompany.deb03.modelo;
...
public class Pelicula {
    ...
    public String toString() {
        var retorno="Pelicula{" + "nombre=" + nombre + ", numdePelicula=" 
                + numdePelicula + ", yearEstreno=" + yearEstreno + ", starPuntacion=" 
                + starPuntacion + ", descripcion=" + descripcion +"su ultimo lanzamiento fue "
                +this.yeasofPublication()+this.BuenaoMalaCritica()+ "}"+" \n";
