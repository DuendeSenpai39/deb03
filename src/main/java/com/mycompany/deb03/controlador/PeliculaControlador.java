 ...
 */
package com.mycompany.deb03.controlador;

import com.mycompany.deb03.modelo.Pelicula;
import com.mycompany.deb03.service.PeliculaServiceImpl;
...
public class PeliculaControlador {
    ...
    public String crear(String[] data,PersonajeControlador[] args){
    ...
    public String modificar(String[] data,PeliculaControlador peliculaControl){
